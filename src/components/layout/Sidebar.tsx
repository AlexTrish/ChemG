...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <motion.aside
      ...
      className={`fixed lg:static inset-y-0 left-0 z-50 w-70 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 ${
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-800">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Химия через игру</p>
            </div>
          </motion.div>
