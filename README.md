# 🎓 ChemG — Гибридная обучающая платформа по школьной химии

## Общее описание

Программа — это гибридная обучающая платформа по школьной химии, сочетающая в себе:
...
- Полка с реактивами.
- Рабочее место (стол).
- Оборудование для реакции.
- Панель уравнений реакции и описания.
...
- **Архитектура:**
  - Фронтенд: React (или Electron для десктопа).
  - Бэкенд (опционально): Python (FastAPI/Flask) или Node.js.
  - ИИ: OpenAI ChatGPT API для генерации текстов.
  - Лаборатория: 2D canvas/WebGL или Godot/WebAssembly.
...
- Мобильная версия.
- Добавление биологии и физики по тому же принципу.
...
1. Скачайте установщик для вашей ОС с [релизов на GitHub](https://github.com/yourusername/chem-learning-platform/releases).
...
```bash
git clone https://github.com/yourusername/chem-learning-platform.git
